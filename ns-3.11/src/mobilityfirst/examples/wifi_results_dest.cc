...
void MoveNodeAway ()
{
	...
	Ptr<NetDevice> node_1 = devices.Get(6);
	...
	Simulator::Schedule (Seconds (10 + xlp.GetValue()), &MoveNodeNear);
...
void MoveNodeNear ()
{
	...
	Simulator::Schedule (Seconds (10 + xlp.GetValue()), &MoveNodeAway);
}
...
int main (int argc, char *argv[])
{
	...
	positionAlloc->Add (Vector (400.0, 235.0, 0.0));
	...
	Time now = Simulator::Now ();
	Simulator::Schedule (Seconds (102), &MoveNodeAway);
