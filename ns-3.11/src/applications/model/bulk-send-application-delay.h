...
#ifndef __bulksend_application_delay_h__
#define __bulksend_application_delay_h__
 ...
 */
class BulkSendApplicationDelay : public Application
{
public:
  static TypeId GetTypeId (void);

  BulkSendApplicationDelay ();

  virtual ~BulkSendApplicationDelay ();
