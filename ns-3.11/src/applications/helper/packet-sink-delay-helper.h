 ...
 */
#ifndef PACKET_SINK_DELAY_HELPER_H
#define PACKET_SINK_DELAY_HELPER_H
...
public:
   ...
   *
   */
  PacketSinkDelayHelper (std::string protocol, Address address);
