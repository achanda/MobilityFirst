#ifndef BYPASS_SOCKET_IMPL_H
#define BYPASS_SOCKET_IMPL_H
...
class BypassSocketImpl : public BypassSocket
{
public:
   ...
   */
  BypassSocketImpl ();
  virtual ~BypassSocketImpl ();

  void SetNode (Ptr<Node> node);
  void SetUdp (Ptr<BypassProtocol> udp);
...
private:
  ...
  friend class BypassSocketFactory;
